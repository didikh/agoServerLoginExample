            ...
            function (TextBox) {
                ...
                loginButton = new Button({
                    ...
                    onClick: function () {
                        ...
                        var params = "client_id=zAPw1EhYp2NZFGT1&response_type=code&redirect_uri=" + redirect_uri;
                        var tgt = (popup == "true") ? 'popup' : '_self';
                        window.open(orgURL + oAuthPath + "?" + params, tgt);
                    }
                }, "login").startup();
